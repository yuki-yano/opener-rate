  ...
  return (
    ...
    >
      <button
        type="button"
        className={cn(
          "group absolute left-2 z-10 inline-flex h-9 w-5 touch-none select-none items-center justify-center rounded-md border border-latte-surface0/80 bg-latte-base text-latte-subtext0 shadow-sm transition hover:border-latte-blue/60 hover:text-latte-blue",
