...
describe("SectionCard", () => {
  ...
  it("applies sticky behavior only to floating actions", () => {
    ...
    const stickyLayerClass =
      html.match(/<div class="([^"]*sticky[^"]*top-3[^"]*)"><div class="[^"]*pointer-events-auto[^"]*">/)?.[1] ??
      "";
    ...
    expect(floatingClass).toContain("[&amp;&gt;button]:bg-latte-surface0");
    expect(floatingClass).toContain("[&amp;&gt;button]:border-latte-surface1");
  });
