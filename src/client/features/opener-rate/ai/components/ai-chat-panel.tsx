...
const ScrollToBottomButton = () => {
  ...
  return (
    <Button
      type="button"
      size="icon"
      className="absolute bottom-4 right-4 z-20 h-10 w-10 rounded-full border border-ui-primary2/60 bg-ui-primary2 text-white shadow-panel hover:bg-ui-primary"
    ...
    >
      <header className="relative flex items-center justify-between border-b border-ui-border1/90 bg-ui-bg/80 px-4 py-3">
        ...
        <div className="relative flex items-center gap-2">
          <Button
            ...
            variant="ghost"
            size="icon"
            className="h-8 w-8 rounded-full border border-transparent bg-ui-layer1/70 text-ui-text2 hover:border-ui-border1 hover:bg-ui-layer1"
          ...
          >
                  ...
                  <div className="max-w-[92%] space-y-1.5">
                    <div
                      className={cn(
                        ...
                        isUser
                          ? "ml-auto border border-ui-border2 bg-ui-bg text-ui-text2"
                          : "border border-ui-border2 bg-ui-bg text-ui-text2",
                      )}
                    >
                      {isUser ? (
                    ...
                    <div
                      className={cn(
                        ...
                        isUser
                          ? "border border-ui-border2 bg-ui-layer2 text-ui-text shadow-sm"
                          : "border border-ui-border2 bg-ui-layer1 text-ui-text shadow-sm",
                      )}
                    >
                      {message.content}
                    </div>
            ...
            {controller.isLoading ? (
              <div className="flex justify-start">
                <div className="inline-flex items-center gap-2 rounded-xl border border-ui-border2 bg-ui-layer1 px-3 py-2 text-xs text-ui-text2 shadow-sm">
      ...
      <div className="space-y-3 border-t border-ui-border1/90 bg-ui-bg/65 px-4 py-3">
            ...
            <div className="flex items-center gap-2">
              {controller.canApplyLastAssistantJson ? (
                <Button
                  type="button"
                  size="sm"
                  className="border border-ui-primary2/70 bg-ui-primary2 text-white hover:bg-ui-primary"
                  onClick={() => {
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="space-y-2 rounded-md border border-ui-border1 bg-ui-bg/70 p-2">
                ...
                <Button
                  type="button"
                  className="w-full border border-ui-primary2/70 bg-ui-primary2 text-white hover:bg-ui-primary"
                  size="sm"
          ...
          <Textarea
            className="min-h-10 max-h-36 flex-1 resize-y rounded-lg border-ui-border2 bg-ui-layer1/95 shadow-none"
          ...
          <Button
            type="submit"
            size="sm"
            className="h-10 shrink-0 rounded-lg border border-ui-primary2/70 bg-ui-primary2 px-4 text-white hover:bg-ui-primary"
